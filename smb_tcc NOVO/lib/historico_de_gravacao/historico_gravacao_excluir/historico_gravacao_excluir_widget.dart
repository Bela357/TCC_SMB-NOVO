            ...
            children: [
              ...
              Align(
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    // Aqui você obtém o modelo e executa a função de exclusão
                    final model = Provider.of<HistoricoGravacaoExcluirModel>(context, listen: false);

                    // Exclui a gravação atual com base no índice selecionado
                    model.excluirGravacao(model.pageViewCurrentIndex);

                    // Após a exclusão, redireciona para a tela de histórico
